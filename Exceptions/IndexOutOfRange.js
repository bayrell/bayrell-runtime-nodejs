...
Runtime.Exceptions.IndexOutOfRange = function(__ctx, context, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, __ctx, __v0.translate(__ctx, "Index out of range", null, "", context), __v1.ERROR_INDEX_OUT_OF_RANGE, context, prev);
};
