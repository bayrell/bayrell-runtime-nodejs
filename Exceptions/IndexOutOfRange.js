...
Runtime.Exceptions.IndexOutOfRange = function(ctx, pos, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, ctx, ctx.constructor.translate(ctx, "Runtime", "Index out of range. Pos: %pos%", use("Runtime.Map").from({"pos":pos})), __v0.ERROR_INDEX_OUT_OF_RANGE, prev);
};
